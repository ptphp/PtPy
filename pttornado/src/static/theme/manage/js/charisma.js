$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','/static/theme/manage/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	var elf = $('.file-manager').elfinder({
		url : '/static/theme/manage/misc/elfinder-connector/connector.php'  // connector URL (REQUIRED)
	}).elfinder('instance');
	...
	//star rating
	$('.raty').raty({
		score : 2, //default stars
		path: '/static/theme/manage/img/'
	});

	//uploadify - multiple uploads
	$('#file_upload').uploadify({
		'swf'      : '/static/theme/manage/misc/uploadify.swf',
		'uploader' : '/static/theme/manage/misc/uploadify.php'
